...
export interface ContainerConfig {
  ...
  /** Model name passed to the provider (e.g. "gemini-3-flash-preview").
   *  Without this in the host-side schema, ensureRuntimeFields' read/write
   *  round-trip silently strips the field from container.json during spawn. */
  model?: string;
}
