...
export const sendMessage: McpToolDefinition = {
  ...
  async handler(args) {
    ...
    if (!text) {
      return err(
        'text was empty after stripping <internal> tags — nothing to send. Put user-facing content outside <internal>...</internal>.',
      );
    }
...
export const editMessage: McpToolDefinition = {
  ...
  async handler(args) {
    ...
    if (!text) {
      return err(
        'text was empty after stripping <internal> tags — refusing to clear the original message. Put user-facing content outside <internal>...</internal>.',
      );
    }
