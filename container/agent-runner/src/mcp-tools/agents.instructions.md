...
- Creates a new agent with its own container, workspace, and session. Your `instructions` string seeds the agent's `GEMINI.local.md` — its starting role and personality.
