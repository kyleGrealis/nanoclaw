...
When a user sends a PDF in chat (Discord, WhatsApp, etc.), it is automatically saved to the group's `attachments/` directory. The message will include a path hint like:

> [PDF: attachments/pdf-1776273018-document.pdf]
