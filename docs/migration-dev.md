...
2. **`/migrate-from-v1` skill** — Claude-driven. Reads the handoff, seeds owner/roles, cleans up GEMINI.local.md, validates container configs, ports fork customizations.
